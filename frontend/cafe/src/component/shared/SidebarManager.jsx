                ...
                <aside id="default-sidebar" className="sticky top-0 left-0 z-40 w-64 transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                    <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-green-700">
                        <ul className="space-y-2">
                            ...
                            <li>
                                <a href="statistik_manager" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <svg
                                        aria-hidden="true"
                                    ...
                                    >
                                        <path
                                            fillRule="evenodd"
                                            d="M5 2a2 2 0 012-2h6a2 2 0 012 2v16a2 2 0 01-2 2H7a2 2 0 01-2-2V2zm2 0a1 1 0 00-1 1v14a1 1 0 001 1h6a1 1 0 001-1V3a1 1 0 00-1-1H7z"
                                        ></path>
                                    </svg>
